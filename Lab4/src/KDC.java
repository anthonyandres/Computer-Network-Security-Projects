...
/*
KDC -> A: Nonce
A -> KDC: E(Ks, [IDa, M, Nonce], SigA(IDa, M)

KDC can verify that the message that A wants to send is not a reply attack, if it is KDC will stop running/communicating with that user
