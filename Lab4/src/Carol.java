...
public class Carol {
    ...
    static String carolNonce = Integer.toString(nonce);
    ...
    public static void main(String[] args) throws IOException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        ...
        ObjectOutputStream publicStream = new ObjectOutputStream(new FileOutputStream("CarolPublicKey.xx"));
        ...
        try (
            ...
            String encodedNonce = rsa.publicEncrypt(carolNonce,kdcKey);
            String encodedKDCNonce = rsa.publicEncrypt(KDCNonce, kdcKey);

            //sending encoded nonces
            System.out.println("Sending bob nonce and KDC nonce: [" + carolNonce + " || " + KDCNonce + "]\n" );
